...
class TestAutoInstaller:
    ...
    def test_init_with_options(self, temp_dir):
    ...
    def test_update_status_not_silent(self, mock_console):
    ...
    def test_update_status_silent(self):
    ...
    @patch("version_checker.utils.auto_installer.console")
    def test_update_status_with_progress(self, mock_console):
    ...
    @patch("version_checker.utils.auto_installer.console")
    def test_kill_process_success(self, mock_console, mock_psutil):
    ...
    @patch("version_checker.utils.auto_installer.psutil")
    def test_kill_process_no_process_running(self, mock_psutil):
    ...
    @patch("version_checker.utils.auto_installer.psutil")
    @patch("version_checker.utils.auto_installer.console")
    def test_kill_process_force_kill(self, mock_console, mock_psutil):
    ...
    @patch("version_checker.utils.auto_installer.psutil")
    @patch("version_checker.utils.auto_installer.console")
    def test_kill_process_error(self, mock_console, mock_psutil):
    ...
    def test_download_success(self, mock_requests, temp_dir):
    ...
    @patch("version_checker.utils.auto_installer.requests")
    def test_download_with_progress(self, mock_requests, temp_dir):
    ...
    @patch("version_checker.utils.auto_installer.requests")
    def test_download_with_callback(self, mock_requests, temp_dir):
    ...
    @patch("version_checker.utils.auto_installer.requests")
    @patch("version_checker.utils.auto_installer.console")
    def test_download_request_error(self, mock_console, mock_requests, temp_dir):
    ...
    def test_extract_and_overwrite_success(self, temp_dir):
    ...
    def test_extract_and_overwrite_with_backup(self, temp_dir):
    ...
    def test_extract_and_overwrite_no_exe_found(self, temp_dir):
    ...
    def test_extract_and_overwrite_bad_zip(self, temp_dir):
    ...
    def test_extract_and_overwrite_no_downloaded_file(self, temp_dir):
    ...
    def test_start_process_windows(self, mock_subprocess, temp_dir):
    ...
    @patch("version_checker.utils.auto_installer.subprocess")
    def test_start_process_unix(self, mock_subprocess, temp_dir):
    ...
    def test_start_process_file_not_found(
        self, mock_console, mock_subprocess, temp_dir
    ):
    ...
    @patch("version_checker.utils.auto_installer.subprocess")
    @patch("version_checker.utils.auto_installer.console")
    def test_start_process_error(self, mock_console, mock_subprocess, temp_dir):
    ...
    def test_cleanup_no_file(self, temp_dir):
    ...
    @patch("version_checker.utils.auto_installer.console")
    def test_cleanup_error(self, mock_console, temp_dir):
    ...
    def test_install_full_process(self, temp_dir):
    ...
    def test_install_download_fails(self, temp_dir):
    ...
    def test_install_extract_fails(self, temp_dir):
    ...
    def test_install_start_process_fails(self, temp_dir):
    ...
    def test_install_with_kill_process(self, temp_dir):
    ...
    def test_install_kill_process_fails(self, temp_dir):
    ...
    @patch("version_checker.utils.auto_installer.console")
    def test_install_exception(self, mock_console, temp_dir):
...
class TestAutoInstallFunction:
    ...
    def test_auto_install_success(self, temp_dir):
    ...
    def test_auto_install_failure(self, temp_dir):
